...
this.driver.js = (function (D) {
  ...
  function ue(e) {
    ...
    return (
      p.setAttribute("d", j(e)),
      (p.style.fill = a("overlayColor") || "rgb(0,0,0)"),
      (p.style.opacity = `${a("overlayOpacity")}`),
  ...
  function ge(e, o) {
    const i = Date.now(),
      ...
      m = a(),
      g = l();
    (!f && d && d(r ? void 0 : n, p, { config: m, state: g }),
      s && s(w ? void 0 : e, o, { config: m, state: g }));
    const u = !f && v;
    let h = !1;
    (xe(),
      b("previousStep", p),
    ...
    const P = () => {
      ...
      const x = Date.now() - i,
        y = 400 - x <= 400 / 2;
      (o.popover && y && !h && u && (J(e, o), (h = !0)),
        a("animate") && x < 400
          ? le(x, 400, n, e)
          : (X(e),
            c && c(w ? void 0 : e, o, { config: a(), state: l() }),
  ...
  function we() {
    var e;
    ((e = document.getElementById("driver-dummy-element")) == null ||
      e.remove(),
  ...
  function Z(e) {
    var t;
    ((t = a("allowKeyboardControl")) == null || t) &&
      (e.key === "Escape"
        ? _("escapePress")
        : e.key === "ArrowRight"
          ? _("arrowRightPress")
          : e.key === "ArrowLeft" && _("arrowLeftPress"));
  }
  function G(e, o, t) {
    const i = (n, f) => {
      const w = n.target;
  ...
  function ye() {
    (window.addEventListener("keyup", Z, !1),
  ...
  function J(e, o) {
    ...
    ((t.nextButton.innerHTML = r),
      ...
      (t.progress.innerHTML = s),
      i
        ? ((t.title.innerHTML = i), (t.title.style.display = "block"))
        : (t.title.style.display = "none"),
      p
        ? ((t.description.innerHTML = p),
          (t.description.style.display = "block"))
        : (t.description.style.display = "none"));
    const c = n || a("showButtons"),
      d = w || a("showProgress") || !1,
      m =
        (c == null ? void 0 : c.includes("next")) ||
        (c == null ? void 0 : c.includes("previous")) ||
        d;
    ((t.closeButton.style.display = c.includes("close") ? "block" : "none"),
      m
        ? ((t.footer.style.display = "flex"),
          (t.progress.style.display = d ? "block" : "none"),
          (t.nextButton.style.display = c.includes("next") ? "block" : "none"),
          (t.previousButton.style.display = c.includes("previous")
            ? "block"
            : "none"))
    ...
    const P =
      ((C = o.popover) == null ? void 0 : C.popoverClass) ||
      a("popoverClass") ||
      "";
    ((u.className = `driver-popover ${P}`.trim()),
      G(
        ...
        (k) => {
          ...
          const T = k.target,
            H =
              ((M = o.popover) == null ? void 0 : M.onNextClick) ||
              a("onNextClick"),
            $ =
              ((R = o.popover) == null ? void 0 : R.onPrevClick) ||
              a("onPrevClick"),
            B =
              ((I = o.popover) == null ? void 0 : I.onCloseClick) ||
              a("onCloseClick");
          if (T.classList.contains("driver-popover-next-btn"))
            return H ? H(e, o, { config: a(), state: l() }) : _("nextClick");
          if (T.classList.contains("driver-popover-prev-btn"))
            return $ ? $(e, o, { config: a(), state: l() }) : _("prevClick");
          if (T.classList.contains("driver-popover-close-btn"))
            return B ? B(e, o, { config: a(), state: l() }) : _("closeClick");
        },
        (k) =>
          !(t != null && t.description.contains(k)) &&
          !(t != null && t.title.contains(k)) &&
          typeof k.className == "string" &&
          k.className.includes("driver-popover"),
      ),
      b("popover", t));
    const S =
      ((y = o.popover) == null ? void 0 : y.onPopoverRender) ||
      a("onPopoverRender");
    (S && S(t, { config: a(), state: l() }), oe(e, o), V(u));
    const L = e.classList.contains("driver-dummy-element"),
      x = q([u, ...(L ? [] : [e])]);
  ...
  function ee(e, o) {
    ...
    return e === "start"
      ? Math.max(
          Math.min(t.top - p, window.innerHeight - i.realHeight - n.width),
          n.width,
        )
      : e === "end"
        ? Math.max(
  ...
  function te(e, o) {
    ...
    return e === "start"
      ? Math.max(
          Math.min(t.left - p, window.innerWidth - i.realWidth - n.width),
          n.width,
        )
      : e === "end"
        ? Math.max(
  ...
  function oe(e, o) {
    const t = l("popover");
    if (!t) return;
    const { align: i = "start", side: p = "left" } =
    ...
    if (
      ...
      ((t.wrapper.style.left = `${C}px`),
        (t.wrapper.style.right = "auto"),
        (t.wrapper.style.top = `${y}px`),
      ...
      ((t.wrapper.style.top = `${C}px`),
        (t.wrapper.style.left = `${y}px`),
        (t.wrapper.style.bottom = "auto"),
        (t.wrapper.style.right = "auto"),
        (x = "top"));
    } else if (g) {
      ...
      ((t.wrapper.style.left = `${y}px`),
        (t.wrapper.style.bottom = `${C}px`),
        (t.wrapper.style.top = "auto"),
        (t.wrapper.style.right = "auto"),
        (x = "bottom"));
    }
    L ? t.arrow.classList.add("driver-popover-arrow-none") : Ce(n, x, e);
  }
  function Ce(e, o, t) {
    const i = l("popover");
    if (!i) return;
    ...
    (o === "top"
      ...
      : o === "bottom"
        ? (s + v <= 0
            ? ((u = "right"), (h = "start"))
            : s + v - w <= 0 && ((u = "bottom"), (h = "start")),
          s >= r
            ? ((u = "left"), (h = "start"))
            : s + w >= r && ((u = "bottom"), (h = "end")))
        : o === "left"
          ? (m + g <= 0
              ? ((u = "bottom"), (h = "end"))
              : m + g - c <= 0 && ((u = "left"), (h = "start")),
            m >= d
              ? ((u = "top"), (h = "end"))
              : m + c >= d && ((u = "left"), (h = "end")))
          : o === "right" &&
  ...
  function ke(e = {}) {
    ...
    function n() {
      ...
      if (
        ...
        return;
      const u =
        ((h = d.popover) == null ? void 0 : h.onPrevClick) || a("onPrevClick");
      if (u) return u(m, d, { config: a(), state: l() });
      i();
    }
    function f() {
      var u;
      ...
      const g =
        ((u = d.popover) == null ? void 0 : u.onNextClick) || a("onNextClick");
      if (g) return g(m, d, { config: a(), state: l() });
      t();
    }
    function w() {
      l("isInitialized") ||
    ...
    function r(s = 0) {
      ...
      const d = c[s],
        ...
        g = c[s - 1],
        u =
          ((H = d.popover) == null ? void 0 : H.doneBtnText) ||
          a("doneBtnText") ||
          "Done",
        h = a("allowClose"),
        P =
          typeof (($ = d.popover) == null ? void 0 : $.showProgress) !=
          "undefined"
            ? (B = d.popover) == null
              ? void 0
              : B.showProgress
            : a("showProgress"),
        L = (
          ((M = d.popover) == null ? void 0 : M.progressText) ||
          a("progressText") ||
          "{{current}} of {{total}}"
        )
          .replace("{{current}}", `${s + 1}`)
          .replace("{{total}}", `${c.length}`),
        x =
          ((R = d.popover) == null ? void 0 : R.showButtons) ||
          a("showButtons"),
        C = ["next", "previous", ...(h ? ["close"] : [])].filter(
          (_e) => !(x != null && x.length) || x.includes(_e),
        ),
        y =
          ((I = d.popover) == null ? void 0 : I.onNextClick) ||
          a("onNextClick"),
        k =
          ((ie = d.popover) == null ? void 0 : ie.onPrevClick) ||
          a("onPrevClick"),
        T =
          ((ne = d.popover) == null ? void 0 : ne.onCloseClick) ||
          a("onCloseClick");
      Q({
        ...d,
        popover: {
    ...
    function v(s = !0) {
      ...
      if (s && g) {
        ...
        g(P ? void 0 : c, d, { config: a(), state: l() });
        return;
      }
      ...
      if (
        ...
        (u && u(P ? void 0 : c, d, { config: a(), state: l() }),
          h && h(P ? void 0 : c, d, { config: a(), state: l() }));
      }
      m && m.focus();
    }
    return {
